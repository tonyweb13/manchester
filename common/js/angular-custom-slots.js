...
app.controller('SlotController', function($scope,$http,$filter) {
    $scope.gspNo = "";
    //$scope.gspSlotItems = {};
    $scope.slotItems = {};
    $scope.category={};
    ...
    $scope.loadSlot = function(gspNo, category){
        ...
        $scope.gspNo = gspNo;
        $('.slot-game-buttons li, .slot-sub-gamebutton li').click(function(){
        ...
        //console.log($scope.gspSlotItems[$scope.gspNo]);
    }
    slotsMasthead();
