...
function browser_detection( $which_test, $test_excludes='', $external_ua_string='' )
{
    ...
    */
    if ( !$b_repeat ) {
        ...
        */
        $a_webkit_types = array( 'arora', 'bolt', 'beamrise', 'chromium', 'puffin', 'chrome', 'crios', 'dooble', 'epiphany', 'gtklauncher', 'icab', 'konqueror', 'maxthon',  'midori', 'omniweb', 'opera', 'qupzilla', 'rekonq', 'rocketmelt', 'samsungbrowser', 'silk', 'uzbl', 'ucbrowser', 'ucweb', 'shiira', 'sputnik', 'steel', 'teashark', 'safari',  'applewebkit', 'webos', 'xxxterm', 'webkit' );
...
function check_is_mobile( $pv_browser_user_agent )
{
    ...
    */
    $a_mobile_search = array(
        ...
        */
        // os
        'android', 'blackberry', 'epoc', 'palmos', 'palmsource', 'windows ce', 'windows phone os', 'symbianos', 'symbian os', 'symbian', 'webos',
...
function get_mobile_data( $pv_browser_user_agent )
{
    ...
    */
    $a_mobile_os = array( 'android', 'blackberry', 'epoc', 'cpu os', 'iphone os', 'palmos', 'palmsource', 'windows phone os', 'windows ce', 'symbianos', 'symbian os', 'symbian', 'webos'  );
