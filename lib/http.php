...
class Http
{
     ...
     * @return Http
     */
    static public function connect($host, $port = 443, $protocol = self::HTTPS)
    {
    ...
    {
        foreach($params as $array=>$param){
//            var_dump($params);
            $this->_requests[] = array(self::POST, $this->_url($url), $param);
        }
        return $this;
    }
    ...
    private function _run()
    {
        ...
        foreach ($this->_requests as $id => $reg) {
            ...
            curl_setopt($curly[$id], CURLOPT_CONNECTTIMEOUT, 6);
