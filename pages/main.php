...
<div class="transactions">
    <div class="tbl-data" >
        ...
        <p ng-repeat="announce in announceList | limitTo: 7">
            ...
            <span class="width68 txt-white text-left" ng-bind="announce.Subject" ng-click="displayCustomer(1); readBoardContent(announce.Type,announce.BoardCode)" style="cursor: pointer;"></span>
        </p>
    </div>
    <div class="tbl-data">
        <h1>실시간 입금 현황</h1>
